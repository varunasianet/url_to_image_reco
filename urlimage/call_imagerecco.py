...
def call_api(url=None, text=None, source_language=None):
    api_url = "http://localhost:9000/process_article"
    # api_url = "https://ai-webstories.asianetnews.org/process_article"
...
if __name__ == "__main__":
    # Example with URL
    article_url = "https://kannada.asianetnews.com/business/flipkart-big-billion-days-amazon-great-indian-festival-sale-2024-gow-sjx11d"
